...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var map = _leaflet2.default.map('map').setView(new _leaflet2.default.LatLng(center.lat, center.lon), 8);
	  ...
	  (0, _map.init)(map);
	  (0, _map.addData)(map, config);

	  (0, _jquery2.default)("#reset").click(function () {
	    (0, _map.resetView)(map, center);
	  });
	  (0, _jquery2.default)("#set").click(function () {
	    (0, _map.setPlace)(map);
	  });
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setPlace(map) {
	  function setPosition(position) {
	    map.setView(new _leaflet2.default.LatLng(position.coords.latitude, position.coords.longitude), 12);
	  };
	...
	function resetView(map, center) {
	  map.setView(new _leaflet2.default.LatLng(center.lat, center.lon), 8);
	};

	function addData(map, config) {
	  var icon = _leaflet2.default.icon({
	    iconUrl: 'img/marker-icon.png',
	    shadowUrl: 'img/marker-shadow.png',
	    iconAnchor: [22, 94],
	  ...
	  for (var i in config.files) {
	    _d2.default.json(config.path + "/" + config.files[i], function (data) {
